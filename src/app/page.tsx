  ...
  <div className="inline-flex items-center px-4 py-2 bg-[rgb(14,129,124)] text-white text-sm rounded-md shadow-lg hover:bg-[rgb(16,98,94)] transition-transform duration-300 transform hover:scale-105">
    ...
    <a href="tel:+254110361540" className="text-white">CALL NOW +254 110361540</a>
      ...
      <div className="flex flex-wrap justify-center gap-8 p-4 sm:p-8">
        {/* Card 1 */}
        <div className="bg-[rgb(14,129,124)] text-white p-6 rounded-lg shadow-lg w-full max-w-sm flex flex-col justify-between overflow-auto" style={{ height: '400px' }}>
          <div>
        ...
        {/* Card 2 */}
        <div className="bg-[rgb(16,98,94)] text-white p-6 rounded-lg shadow-lg w-full max-w-sm flex flex-col justify-between overflow-auto" style={{ height: '400px' }}>
          <div>
