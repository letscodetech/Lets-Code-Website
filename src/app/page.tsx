...
const services: Array<{
  ...
  },
  {
    ...
    features: ["Web & mobile apps", "Business management systems", "API integrations", "Ongoing support"],
...
const accentClasses: Record<Accent, {
  ...
  teal: {
    ...
    icon: "from-teal-500/20 to-teal-600/20",
    iconColor: "text-teal-400",
    dot: "bg-teal-400",
    btn: "bg-gradient-to-r from-teal-500 to-teal-600 text-white",
    eyebrow: "text-teal-400",
  },
  emerald: {
    border: "hover:border-emerald-500/40",
    icon: "from-emerald-500/20 to-emerald-600/20",
    iconColor: "text-emerald-400",
    dot: "bg-emerald-400",
    btn: "bg-gradient-to-r from-emerald-500 to-emerald-600 text-white",
...
export default function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>LetsCode Ltd | Tech Courses, School Training & Software Development in Kenya</title>
        <meta name="description" content="LetsCode Ltd offers tech courses, school career days, B2B corporate training, and custom software development across Kenya. Kenya's leading tech education and software partner." />
        <meta name="keywords" content="LetsCode, tech training Kenya, coding courses Nairobi, B2B tech training, school career day Kenya, software development Kenya, Python, JavaScript, AI, fullstack, web development" />
        <meta name="author" content="LetsCode Ltd" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta property="og:title" content="LetsCode Ltd | Tech Courses, School Training & Software in Kenya" />
        <meta property="og:description" content="Courses for individuals, career days for schools, training for companies, and software for businesses. LetsCode is Kenya's all-in-one tech partner." />
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {mounted && [...Array(6)].map((_, i) => (
            <motion.div
              ...
              transition={{ duration: 12 + i * 2, repeat: Infinity, repeatType: "reverse" }}
            />
          ))}
        </div>
        ...
        <header className="relative pt-32 pb-20 px-4 text-center z-10">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-4">
              Tech courses for individuals. Career days for schools. Training for companies. Software for businesses.
            </p>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <motion.a
                href={buildWhatsAppUrl(`Hi, I'd like to learn more about LetsCode's services.`)}
                target="_blank"
                  ...
                  >
                    ...
                    <div className="p-8 flex-1">
                      <div className="flex items-start gap-4 mb-5">
                        <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${a.icon} flex items-center justify-center flex-shrink-0`}>
                          <service.icon className={`w-6 h-6 ${a.iconColor}`} />
                        </div>
                        <div>
                          <p className={`text-xs font-medium uppercase tracking-widest mb-1 ${a.eyebrow}`}>
                            {service.eyebrow}
                          </p>
                    ...
                    <div className="px-8 pb-8">
                      {service.href ? (
                        ...
                        <motion.a
                          href={buildWhatsAppUrl(service.wa!)}
                          target="_blank"
                          rel="noopener noreferrer"
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                <div>
                  ...
                  <h2 className={`${spaceMono.className} text-3xl font-bold mb-4`}>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    ...
                    { icon: MonitorSmartphone, label: "Production-grade software" },
                  ].map((item) => (
                    <div
                      key={item.label}
        ...
        <section id="testimonials" className="py-20 px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-400 max-w-2xl mx-auto">
                From students landing their first tech jobs to businesses shipping better software.
              </p>
            </motion.div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <section id="clients" className="py-20 px-4 relative z-10">
          <div className="max-w-6xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-400 max-w-2xl mx-auto">
                Businesses across Kenya trust us to build their software and train their teams.
              </p>
            </motion.div>
            <motion.div
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4">
                  <motion.a
                    href={buildWhatsAppUrl(`Hi, I'd like to work with LetsCode. Can we discuss what you offer?`)}
                    target="_blank"
                    rel="noopener noreferrer"
