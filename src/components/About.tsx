    ...
    <main id="main">
      ...
      <section id="who-we-are" className="py-12">
        <div className="container mx-auto flex flex-col md:flex-row items-center">
          ...
          <div className="flex-1 md:ml-8">
            <span className="block text-lg font-semibold mb-4">Who We Are</span>
      ...
      <section id="staff" className="py-12">
        <div className="text-center mb-8">
          <span className="block text-lg font-semibold mb-4">Our Team</span>
        ...
        <div className="container mx-auto flex flex-wrap justify-center">
          ...
          <div className="flex flex-col md:flex-row items-center mb-8 w-full md:w-auto">
            ...
            <div className="text-center md:text-left mt-6 md:mt-0 md:ml-6">
              <h3 className="text-xl font-semibold">Mollen Wambui</h3>
              <span className="block text-sm font-medium mb-2">Founder & CEO</span>
              <p>
          ...
          <div className="flex flex-col md:flex-row items-center mb-8 w-full md:w-auto">
            <Image
              src="/images/Kenneth Ndiritu.jpg"  // Replace with the actual image path for Kenneth
              alt="Kenneth Ndiritu"
              width={500}
              height={300}
              layout="responsive"
            ...
            />
            <div className="text-center md:text-left mt-6 md:mt-0 md:ml-6">
              <h3 className="text-xl font-semibold">Kenneth Ndiritu</h3>
              <span className="block text-sm font-medium mb-2">Board Advisor</span>
              <p>
          ...
          <div className="flex flex-col md:flex-row items-center mb-8 w-full md:w-auto">
            ...
            />
            <div className="text-center md:text-left mt-6 md:mt-0 md:ml-6">
              <h3 className="text-xl font-semibold">Lucy Wangari</h3>
              <span className="block text-sm font-medium mb-2">Chief Financial Officer</span>
              <p>
