    ...
    <main id="testimonials">
      ...
      <section id="testimonials" className="py-12">
        <div className="text-center mb-8">
          <span className="block text-lg font-semibold mb-4 mt-10">What Our Clients Say</span>
        ...
        <div className="container mx-auto flex flex-wrap justify-center gap-8">
          {/* Testimonial Card 1 */}
          <div className={`relative bg-[rgb(14,129,124)] text-black p-6 rounded-lg shadow-lg w-full md:w-1/3 transition-transform duration-500 ease-in-out ${animation ? 'transform translate-x-5' : ''}`}>
